...
public class ToxicMeteorPotionStarategy : IPassiveStrategy
{
    private ToxicMeteorPotionSkillDataSO mSkillDataSO;

    private ToxicMeteorPotion mPotionPrefab;

    private ToxicMeteorPotion mPotion;

    private float mPotionSpawnDelay;
    private float mTimer = 0;

    public ToxicMeteorPotionStarategy(ToxicMeteorPotionSkillDataSO skillDataSO)
    {
