...
public class MeleeModifiedCombatState : EnemyState
{
    ...
    public MeleeModifiedCombatState(MeleeEnemy enemy, IState parent = null) : base(enemy, parent)
    {
        mHitBoxOffsetForward = mEnemy.AttackRange;
        mHitBoxRadius = mEnemy.AttackRange / 2.0f;
        mHitTiming = mEnemy.AttackSpeed;
        mCombatBT = new RepeaterNode(BT_Builder.ModifiedChaseAndAttackBT
            (
