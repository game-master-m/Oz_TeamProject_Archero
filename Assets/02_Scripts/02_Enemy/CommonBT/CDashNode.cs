...
public class CDashNode : ActionNode
{
    ...
    public CDashNode(EnemyBase owner, BlackBoard board, float chargeTime, float targetFixTime, float moveSpeedMultiplier, float animSpeedRate, float colliderRadius) : base(owner)
    {
        mBoard = board;
